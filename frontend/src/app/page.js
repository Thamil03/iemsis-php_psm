...
export default function Home() {
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await fetch(`https://iemsweb.online/equipment/EquipmentController.php?search=${searchNumber}`);
      const data = await res.json();
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch('https://iemsweb.online/user/UserController.php?action=forgot_password', {
        method: 'POST',
        headers: {
