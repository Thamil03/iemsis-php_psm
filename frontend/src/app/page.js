...
export default function Home() {
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      try {
        const res = await fetch("https://dolphin-app-gllbf.ondigitalocean.app/notifications/NotificationsController.php");
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await fetch(`https://dolphin-app-gllbf.ondigitalocean.app/equipment/EquipmentController.php?search=${searchNumber}`);
      const data = await res.json();
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await fetch('https://dolphin-app-gllbf.ondigitalocean.app/user/UserController.php?action=forgot_password', {
        method: 'POST',
        headers: {
