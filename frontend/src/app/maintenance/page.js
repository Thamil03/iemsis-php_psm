...
export default function MaintenancePage() {
  ...
  const fetchMaintenanceRecords = async () => {
    try {
      const response = await fetch("https://iemsweb.online/iemsis-php_psm/backend/maintenance/fetch_all.php");
    ...
    if (window.confirm("Are you sure you want to delete this maintenance record?")) {
      try {
        const response = await fetch(
          `https://iemsweb.online/iemsis-php_psm/maintenance/MaintenanceController.php?action=delete&id=${id}`,
          {
            method: "DELETE",
            credentials: "include",
          }
  ...
  const handleSave = async () => {
    ...
    const url = editingId
      ? `https://iemsweb.online/iemsis-php_psm/backend/maintenance/update.php?id=${editingId}`
      : "https://iemsweb.online/iemsis-php_psm/backend/maintenance/add.php";
