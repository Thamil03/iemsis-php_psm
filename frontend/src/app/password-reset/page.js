...
export default function PasswordReset() {
  ...
  useEffect(() => {
    ...
    const checkResetStatus = async () => {
      try {
        const res = await fetch('https://dolphin-app-gllbf.ondigitalocean.app/auth/check_reset_status.php', {
          method: 'GET',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://dolphin-app-gllbf.ondigitalocean.app/auth/reset_password.php', {
        method: 'POST',
