...
export default function PasswordReset() {
  ...
  useEffect(() => {
    ...
    const checkResetStatus = async () => {
      try {
        const res = await fetch('https://iemsweb.online/iemsis-php_psm/auth/check_reset_status.php', {
          method: 'GET',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://iemsweb.online/iemsis-php_psm/auth/reset_password.php', {
        method: 'POST',
