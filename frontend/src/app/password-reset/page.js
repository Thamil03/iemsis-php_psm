...
export default function PasswordReset() {
  ...
  useEffect(() => {
    ...
    const checkResetStatus = async () => {
      try {
        const res = await fetch('http://188.166.227.229/iemsis-php/auth/check_reset_status.php', {
          method: 'GET',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch('http://188.166.227.229/iemsis-php/auth/reset_password.php', {
        method: 'POST',
